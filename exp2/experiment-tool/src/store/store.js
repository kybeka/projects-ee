...
export default createStore({
  state: {
    ...
    questions: [
      ...
      {
        id: 'question7',
        questionText: 'wording changes',
        options: ['wording-changes', 'wording-chagnes', 'warding-changes', 'wording-chanes'],
        caseFormat: 'kebab4',
        correctAnswerIndex: 0,
      },
      {
        id: 'question8',
        questionText: 'wording changes',
        options: ['wordingChanges', 'wordingChagnes', 'wardingChanges', 'wordingChanes'],
        caseFormat: 'camel4',
        correctAnswerIndex: 0,
      },
      {
